...
class LivroControllerApiUnitTest {
    ...
    void listarVitrine_ComPromocao() {
        // Arrange
        when(livroService.listarPromocoesAtivasPaginado(any(), any()))
                .thenReturn(Page.empty());

        // Act
        ResponseEntity<?> response = controller.listarVitrine(0, 20, true, null);

        // Assert
        assertEquals(HttpStatus.OK, response.getStatusCode());
        verify(livroService).listarPromocoesAtivasPaginado(any(), any());
    }

    @Test
    void listarVitrine_SemPromocao() {
        // Arrange
        when(livroService.listarLivrosAprovadosPaginado(any(), any()))
                .thenReturn(Page.empty());

        // Act
        ResponseEntity<?> response = controller.listarVitrine(0, 20, false, null);

        // Assert
        assertEquals(HttpStatus.OK, response.getStatusCode());
        verify(livroService).listarLivrosAprovadosPaginado(any(), any());
    }
    ...
    void listarVitrine_promocao() {
        ...
        ResponseEntity<?> resp = controller.listarVitrine(0, 10, true, "java");
    ...
    void listarVitrine_normal() {
        ...
        ResponseEntity<?> resp = controller.listarVitrine(0, 10, false, null);
