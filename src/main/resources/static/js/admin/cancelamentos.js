...
function statusBadge(status) {
    ...
    return `<span class="badge ${cls[status] || ''}">${label[status] || escHtml(status)}</span>`;
}
        ...
        <div class="compact-card ${isPendente ? 'card-pendente' : ''}"
            ...
            <div class="compact-info">
                ...
                <div class="compact-comprador">
                    ...
                    <span class="compact-email">${escHtml(s.clienteEmail)}</span>
                </div>
            </div>
            <div class="compact-meta">
                ...
                <div class="compact-bottom">
                    <span class="compact-estorno">
                        <i class="fa-solid fa-coins"></i> T$ ${(s.precoLivro || 0).toFixed(2)}
                    </span>
                    <span class="compact-data">${fmtData(s.dataSolicitacao)}</span>
                </div>
            </div>
