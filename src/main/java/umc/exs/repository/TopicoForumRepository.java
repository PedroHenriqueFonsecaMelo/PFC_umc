...
public interface TopicoForumRepository extends JpaRepository<TopicoForum, Long> {
    ...
    // Lista paginada — @EntityGraph carrega o autor em JOIN, evitando LazyInitializationException
    ...
    // Detalhe do tópico — carrega autor + respostas + autor de cada resposta em uma query
    @Query("""
