...
public interface LivroRepository extends JpaRepository<Livro, Long> {
    ...
    @Query("""
                ...
                WHERE l.aprovado = true
                  ...
                  AND (LOWER(l.titulo) LIKE LOWER(CONCAT('%', :busca, '%'))
                       ...
                       OR LOWER(l.autor) LIKE LOWER(CONCAT('%', :buscaNorm, '%')))
            """)
    Page<Livro> findPromocoesAtivasPaginadoComBusca(@Param("agora") LocalDateTime agora,
            @Param("busca") String busca,
            @Param("buscaNorm") String buscaNorm, Pageable pageable);

    List<Livro> findByAprovadoFalse();

    Page<Livro> findByAprovadoFalse(Pageable pageable);
    ...
    boolean existsByIsbnAndAprovadoTrue(String isbn);

    boolean existsByTituloIgnoreCaseAndAprovadoTrue(String titulo);
}