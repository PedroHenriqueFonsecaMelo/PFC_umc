...
public class EmailHtmlBuilder {
        ...
        public static String compraSucesso(String nome, String livro, Double preco, Double saldo, String data) {
                ...
                String conteudo = EmailComponents.h2(OLA + nome + "!")
                                ...
                                + EmailComponents.caixa(
                                                EmailComponents.p("<strong>" + LIVRO + "</strong> " + livro)
                                                                + EmailComponents.p("<strong>" + VALOR + "</strong> "
                                                                                + preco)
                                                                + EmailComponents.p(
                                                                                "<strong>Saldo restante: R$ </strong>"
                                                                                                + saldo)
                                                                + EmailComponents.p("<strong>" + DATA + "</strong> "
                                                                                + data))
        ...
        public static String livroAprovado(String nome, String livro, double valor) {
                ...
                String conteudo = EmailComponents.h2("Livro aprovado!")
                                + EmailComponents.p("Seu livro foi aprovado e já está disponível na vitrine.")
                                + EmailComponents.caixa(
                                                EmailComponents.p("<strong>" + LIVRO + "</strong>" + livro)
                                                                + EmailComponents.p("<strong>Recompensa: R$ </strong>"
                                                                                + valor));
        ...
        public static String livroRejeitado(String nome, String livro, String motivo) {
                ...
                String conteudo = EmailComponents.h2("Livro não aprovado")
                                + EmailComponents.caixa(
                                                EmailComponents.p("<strong>" + LIVRO + "</strong>" + livro))
        ...
        public static String contaSuspensa(String nome, String motivo, LocalDateTime suspensaoAte) {
                ...
                String conteudo = EmailComponents.h2("Olá, " + nome + ".")
                                + EmailComponents.p(
                                                "Sua conta na <strong>Bibliotroca</strong> foi <strong style='color:#b45309'>suspensa</strong>.")
                                + EmailComponents.caixa(
        ...
        public static String contaReativada(String nome, String mensagem) {
                ...
                String conteudo = EmailComponents.h2("Olá, " + nome + ".")
                                + EmailComponents.p(
                                                "Sua conta na <strong>Bibliotroca</strong> foi <strong style='color:#2e7d32'>reativada</strong> com sucesso.")
        ...
        public static String respostaReporte(String mensagem) {
                String conteudo = EmailComponents.h2("Retorno da equipe Bibliotroca")
                                ...
                                + EmailComponents.p(
                                                "Se precisar de mais ajuda, entre em contato conosco novamente pela plataforma.")
                                + EmailComponents.aviso(
                                                "Este é um retorno da equipe Bibliotroca referente ao seu reporte de problema.");
        ...
        public static String contaRemovida(String nome, String motivo, Double saldoTokens) {
                ...
                String conteudo = EmailComponents.h2("Olá, " + nome + ".")
                                + EmailComponents.p(
                                                "Sua conta na <strong>Bibliotroca</strong> foi <strong style='color:#722f37'>removida</strong> permanentemente.")
                                + EmailComponents.caixa(
                                                EmailComponents.p("<strong>Motivo:</strong> " + motivo))
                                + saldoInfo
                                + EmailComponents.p(
                                                "Esta ação é irreversível. Todos os seus dados foram removidos da plataforma.")
                                + EmailComponents.p("Se acredita que houve um engano, entre em contato com o suporte.")
                                + EmailComponents.p("Equipe Bibliotroca.");
